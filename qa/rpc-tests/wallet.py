...
#   c) node1 mines 32 blocks, so now node 0 has 500000SWIFT, node 1 has 4250SWIFT, node2 has none.
#   d) node0 sends 601 SWIFT to node2, in two transactions (301 SWIFT, then 300 SWIFT).

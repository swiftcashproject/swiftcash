Contributing to SwiftCash Core
==================================

The SwiftCash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SwiftCash Core project, and is not to be
confused with overall SwiftCash Network Protocol consensus changes.

Whether a pull request is merged into SwiftCash Core rests with the project merge
...
Patches that change SwiftCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the SwiftCash consensus, it must have been
...
The project leader is the release manager for each SwiftCash Core release.

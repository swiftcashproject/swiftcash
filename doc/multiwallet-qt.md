...
In order to support loading of multiple wallets in swiftcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is swiftcash.cpp.
...
Changes to swiftcash.cpp
----------------------
swiftcash.cpp is the entry point into swiftcash-qt, and as such, will require some minor modifications to provide hooks for

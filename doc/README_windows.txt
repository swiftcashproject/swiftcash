...
Intro
-----
SwiftCash (SWIFT) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. SwiftCash utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run swiftcash-qt.exe.

SwiftCash Core is the original SwiftCash client and it builds the backbone of the network.
However, it downloads and stores the entire history of SwiftCash transactions;

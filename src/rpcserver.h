...
/**
 * SwiftCash RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue convertoldaddress(const UniValue& params, bool fHelp);
extern UniValue convertoldprivkey(const UniValue& params, bool fHelp);
...
extern UniValue swiftnode(const UniValue& params, bool fHelp); // in rpcswiftnode.cpp
extern UniValue listswiftnodes(const UniValue& params, bool fHelp);
extern UniValue getswiftnodecount(const UniValue& params, bool fHelp);
extern UniValue swiftnodeconnect(const UniValue& params, bool fHelp);
extern UniValue swiftnodecurrent(const UniValue& params, bool fHelp);
extern UniValue swiftnodedebug(const UniValue& params, bool fHelp);
...
extern UniValue getswiftnodescores(const UniValue& params, bool fHelp);

extern UniValue mnbudget(const UniValue& params, bool fHelp); // in rpcswiftnode-budget.cpp

...
// swiftcash: total coin age spent in transaction, in the unit of coin-days.
...
int64_t GetBlockValue(int nHeight)
{
	...
	nSubsidy = 1270162 * COIN; // exact amount of forkdrops + 1M initial development = 77,270,162 SWIFT

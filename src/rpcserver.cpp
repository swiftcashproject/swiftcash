...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SwiftCash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SwiftCash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SwiftCash features */
        {"swiftcash", "swiftnode", &swiftnode, true, true, false},
        {"swiftcash", "listswiftnodes", &listswiftnodes, true, true, false},
        {"swiftcash", "getswiftnodecount", &getswiftnodecount, true, true, false},
        {"swiftcash", "swiftnodeconnect", &swiftnodeconnect, true, true, false},
        {"swiftcash", "swiftnodecurrent", &swiftnodecurrent, true, true, false},
        {"swiftcash", "swiftnodedebug", &swiftnodedebug, true, true, false},
        ...
        {"swiftcash", "getswiftnodescores", &getswiftnodescores, true, true, false},
        {"swiftcash", "mnbudget", &mnbudget, true, true, false},
        {"swiftcash", "preparebudget", &preparebudget, true, true, false},
        ...
        {"swiftcash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"swiftcash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"swiftcash", "checkbudgets", &checkbudgets, true, true, false},
        {"swiftcash", "mnsync", &mnsync, true, true, false},
        {"swiftcash", "spork", &spork, true, true, false},
        ...
        {"wallet", "convertoldaddress", &convertoldaddress, false, false, true},
        {"wallet", "convertoldprivkey", &convertoldprivkey, false, false, true},
        ...
        {"wallet", "lottery", &lottery, false, false, true},
        {"wallet", "hodldeposit", &hodldeposit, false, false, true},
        {"wallet", "sendtoaddress", &sendtoaddress, false, false, true},
        {"wallet", "sendtoaddresslocked", &sendtoaddresslocked, false, false, true},
...
{
    return "> swiftcash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8543/\n";
}

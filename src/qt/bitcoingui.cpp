                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SwiftCash Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    QFontDatabase::addApplicationFont(":/fonts/Montserrat-ExtraLight");
    ...
    QFontDatabase::addApplicationFont(":/fonts/Montserrat-Thin");
    QFontDatabase::addApplicationFont(":/fonts/Lato-Black");
    QFontDatabase::addApplicationFont(":/fonts/Lato-Bold");
    QFontDatabase::addApplicationFont(":/fonts/Lato-Hairline");
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SWIFT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and swiftcash: URIs)"));
    ...
    QSettings settings;
    if (settings.value("fShowSwiftnodesTab").toBool()) {
        QPixmap swiftnodesIconInactive(":/icons/swiftnodes");
        QPixmap swiftnodesIconActive(":icons/swiftnodes_active");
        QIcon swiftnodesIcon(swiftnodesIconInactive);

        swiftnodesIcon.addPixmap(swiftnodesIconActive,QIcon::Selected,QIcon::On);
        swiftnodesIcon.addPixmap(swiftnodesIconActive,QIcon::Selected,QIcon::Off);
        swiftnodesIcon.addPixmap(swiftnodesIconActive,QIcon::Active,QIcon::On);
        swiftnodesIcon.addPixmap(swiftnodesIconActive,QIcon::Active,QIcon::Off);

        swiftnodeAction = new QAction(swiftnodesIcon, tr("&SwiftNodes"), this);
        swiftnodeAction->setStatusTip(tr("Browse swiftnodes"));
        swiftnodeAction->setToolTip(swiftnodeAction->statusTip());
        swiftnodeAction->setCheckable(true);
#ifdef Q_OS_MAC
        swiftnodeAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_6));
#else
        swiftnodeAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
#endif
        tabGroup->addAction(swiftnodeAction);
        connect(swiftnodeAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
        connect(swiftnodeAction, SIGNAL(triggered()), this, SLOT(gotoSwiftnodePage()));
    }
    ...
    proposalAction->setStatusTip(tr("Browse proposals/budgets"));
    ...
    aboutAction = new QAction(QIcon(":/icons/overview"), tr("&About SwiftCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about SwiftCash Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for SwiftCash"));
    ...
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SWIFT addresses"));
    ...
    openMNConfEditorAction = new QAction(QIcon(":/icons/edit_black"), tr("Open &SwiftNode Configuration File"), this);
    openMNConfEditorAction->setStatusTip(tr("Open SwiftNode configuration file"));
    ...
    openAction = new QAction(QIcon(":/icons/editcopy"), tr("Open &URI..."), this);
    openAction->setStatusTip(tr("Open a swiftcash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain Explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-Line Options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SwiftCash Core help message to get a list with possible SwiftCash command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        QSettings settings;
        if (settings.value("fShowSwiftnodesTab").toBool()) {
            toolbar->addAction(swiftnodeAction);
        }
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    swiftnodeAction->setEnabled(enabled);
    QSettings settings;
    if (settings.value("fShowSwiftnodesTab").toBool()) {
        swiftnodeAction->setEnabled(enabled);
    }
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SwiftCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::gotoSwiftnodePage()
{
    QSettings settings;
    if (settings.value("fShowSwiftnodesTab").toBool()) {
        swiftnodeAction->setChecked(true);
        if (walletFrame) walletFrame->gotoSwiftnodePage();
    }
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SwiftCash network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    if (swiftnodeSync.IsBlockchainSynced()) {
        ...
        if (swiftnodeSync.IsSynced()) {
            ...
            nAttempt = swiftnodeSync.RequestedSwiftnodeAttempt < SWIFTNODE_SYNC_THRESHOLD ?
                           swiftnodeSync.RequestedSwiftnodeAttempt + 1 :
                           SWIFTNODE_SYNC_THRESHOLD;
            progress = nAttempt + (swiftnodeSync.RequestedSwiftnodeAssets - 1) * SWIFTNODE_SYNC_THRESHOLD;
            progressBar->setMaximum(4 * SWIFTNODE_SYNC_THRESHOLD);
            progressBar->setFormat(tr("Synchronizing additional data: %p%"));
            progressBar->setValue(progress);
        }

        strSyncStatus = QString(swiftnodeSync.GetSyncStatus().c_str());
...
{
    QString strTitle = tr("SwiftCash Core"); // default title

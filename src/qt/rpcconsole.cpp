...
void RPCConsole::setClientModel(ClientModel* model)
{
    ...
    if (model) {
        ...
        setSwiftnodeCount(model->getSwiftnodeCountString());
        connect(model, SIGNAL(strSwiftnodesChanged(QString)), this, SLOT(setSwiftnodeCount(QString)));
...
void RPCConsole::setSwiftnodeCount(const QString& strSwiftnodes)
{
    ui->swiftnodeCount->setText(strSwiftnodes);
}

...
void SignVerifyMessageDialog::on_signMessageButton_SM_clicked()
{
    ...
    if (!addr.IsValid()) {
        ui->statusLabel_SM->setStyleSheet("QLabel { color: #E1755A; }");
    ...
    ui->statusLabel_SM->setStyleSheet("QLabel { color: #5ae16c; }");
...
void SignVerifyMessageDialog::on_verifyMessageButton_VM_clicked()
{
    ...
    if (!addr.IsValid()) {
        ui->statusLabel_VM->setStyleSheet("QLabel { color: #E1755A; }");
    ...
    ui->statusLabel_VM->setStyleSheet("QLabel { color: #5ae16c; }");

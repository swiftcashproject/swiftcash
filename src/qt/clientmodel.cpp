...
QString ClientModel::getSwiftnodeCountString() const
{
...
void ClientModel::updateTimer()
{
    ...
    if (cachedNumBlocks != newNumBlocks ||
        ...
        swiftnodeSync.RequestedSwiftnodeAttempt != prevAttempt || swiftnodeSync.RequestedSwiftnodeAssets != prevAssets) {
        cachedNumBlocks = newNumBlocks;
        cachedReindexing = fReindex;
        cachedImporting = fImporting;
        prevAttempt = swiftnodeSync.RequestedSwiftnodeAttempt;
        prevAssets = swiftnodeSync.RequestedSwiftnodeAssets;
...
void ClientModel::updateMnTimer()
{
    ...
    if (!lockMain)
        return;
    QString newSwiftnodeCountString = getSwiftnodeCountString();

    if (cachedSwiftnodeCountString != newSwiftnodeCountString) {
        cachedSwiftnodeCountString = newSwiftnodeCountString;

        emit strSwiftnodesChanged(cachedSwiftnodeCountString);
    }
}

...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        intro.setWindowIcon(QIcon(":icons/swiftcash"));
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SwiftCash Core"),
     ...
     * override -datadir in the swiftcash.conf file in the default data directory
     * (to be consistent with swiftcashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())

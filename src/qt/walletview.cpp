                                          ...
                                          walletModel(0)
{
    ...
    if (settings.value("fShowSwiftnodesTab").toBool()) {
        swiftnodeListPage = new SwiftnodeList();
...
void WalletView::setClientModel(ClientModel* clientModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowSwiftnodesTab").toBool()) {
        swiftnodeListPage->setClientModel(clientModel);
    }
}
...
void WalletView::setWalletModel(WalletModel* walletModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowSwiftnodesTab").toBool()) {
        swiftnodeListPage->setWalletModel(walletModel);
    }
...
void WalletView::gotoSwiftnodePage()
{
    QSettings settings;
    if (settings.value("fShowSwiftnodesTab").toBool()) {
        setCurrentWidget(swiftnodeListPage);
    }
}

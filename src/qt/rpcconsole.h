...
public slots:
    ...
    /** Set number of swiftnodes shown in the UI */
    void setSwiftnodeCount(const QString& strSwiftnodes);
    ...
    void showRepair();
    /** Open external (default) editor with swiftcash.conf */
    void showConfEditor();
    /** Open external (default) editor with swiftnode.conf */

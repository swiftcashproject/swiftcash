...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SWIFT);
    ...
    if (!settings.contains("fShowSwiftnodesTab"))
        settings.setValue("fShowSwiftnodesTab", swiftnodeConfig.getCount());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in swiftcash.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case ShowSwiftnodesTab:
            return settings.value("fShowSwiftnodesTab");
#endif
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case SpendZeroConfChange:
            ...
            break;
        case ShowSwiftnodesTab:
            if (settings.value("fShowSwiftnodesTab") != value) {
                settings.setValue("fShowSwiftnodesTab", value);
                setRestartRequired(true);
            }
            break;
#endif

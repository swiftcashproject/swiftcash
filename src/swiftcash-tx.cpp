...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SwiftCash Core swiftcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  swiftcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded swiftcash transaction") + "\n" +
                               "  swiftcash-tx [options] -create [commands]   " + _("Create hex-encoded swiftcash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded swiftcash transaction

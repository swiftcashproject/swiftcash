...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    /* SX7ex6vUHtw1y5hYrzpAXrM4vthtCA2cfW is not owned by the test wallet. */
    BOOST_CHECK_THROW(CallRPC("setaccount SX7ex6vUHtw1y5hYrzpAXrM4vthtCA2cfW nullaccount"), runtime_error);
    ...
    BOOST_CHECK_THROW(CallRPC("signmessage SX7ex6vUHtw1y5hYrzpAXrM4vthtCA2cfW mymessage"), runtime_error);
    ...
    /* wrong address */
    BOOST_CHECK(CallRPC("verifymessage SX7ex6vUHtw1y5hYrzpAXrM4vthtCA2cfW " + retValue.get_str() + " mymessage").get_bool() == false);

...
enum AvailableCoinsType {
    ALL_COINS = 1,
    ONLY_NOT10000IFMN = 3,
    ONLY_10000 = 5,                        // find swiftnode outputs including locked ones (use with caution)
...
public:
    ...
    bool fMultiSendSwiftnodeReward;
    ...
    void SetNull()
    {
        ...
        fMultiSendSwiftnodeReward = false;
    ...
    {
        return fMultiSendSwiftnodeReward || fMultiSendStake;
    }
    ...
    /// Get 1000DASH output and keys which can be used for the Swiftnode
    bool GetSwiftnodeVinAndKeys(CTxIn& txinRet, CPubKey& pubKeyRet, CKey& keyRet, std::string strTxHash = "", std::string strOutputIndex = "");
    ...
    bool GetLotteryTicketCollateralTX(CWalletTx& tx, CScript scriptPubKey, CAmount nAmount, bool useIX);

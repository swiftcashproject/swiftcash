...
Community proposals will be allowed to use 70% of the block rewards for budgetting as calculated with the following formula. Currently 10% of future block rewards should be used for funding SwiftRewards. The percentage of future block rewards set aside for SwiftRewards is expected to rise 5% every year until it reaches 60% in 2029. That means budget ceiling for other activities such as funding development is expected to decline 5% every year until it reaches 10% in 2029. Having said that, any amount that is not used can be mined in the future for budgetting or other purposes such as mining or staking. SwiftCash block rewards start with a minimum of 60 SWIFT per block after block 10,000, and slowly curve towards 0 until maximum supply of 5,000,000,000 SWIFT is reached. However, reaching the maximum supply should never happen, since transaction fees are continuously burned out of the circulating supply!
